...
"""
binary_numbers = input('input binary numbers: ').split(',')
binary_numbers = [int(number, 2) for number in binary_numbers]
binary_numbers = [str(bin(number)) for number in binary_numbers if number % 5 == 0]
